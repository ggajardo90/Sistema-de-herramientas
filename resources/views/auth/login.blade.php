@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Switch Chile')])
      ...
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="card-footer-btn btn btn-primary btn-link btn-lg">{{ __('Iniciar') }}</button>
          </div>
        </div>
      </form>
      <div class="row">
